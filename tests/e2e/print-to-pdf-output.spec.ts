...
describe('Print to PDF Output Verification', () => {
    ...
    describe('Rapid Print Handling', () => {
        it('should handle rapid print triggers without crash or corruption', async function () {
            ...
            const dialogCallCount = await browser.electron.execute((electron: typeof import('electron')) => {
            ...
            E2ELogger.info('print-to-pdf-output', `Dialog called ${dialogCallCount} time(s) - rapid requests handled`);
