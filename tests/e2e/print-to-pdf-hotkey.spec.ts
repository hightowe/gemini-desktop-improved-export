...
describe('Print to PDF Hotkey', () => {
    ...
    describe('Hotkey Registration', () => {
        it('should have printToPdf defined in REGISTERED_HOTKEYS', () => {
            ...
            E2ELogger.info('print-to-pdf-hotkey', `Accelerator: ${REGISTERED_HOTKEYS.PRINT_TO_PDF.accelerator}`);
        });
    ...
    describe('Custom Accelerator', () => {
        it('should update menu item accelerator when changed in Options', async () => {
            ...
            await browser.waitUntil(async () => await optionsPage.isRecordingModeActive(PRINT_TO_PDF_HOTKEY_ID), {
                timeout: 2000,
