...
describe('UpdateToast', () => {
    ...
    describe('rendering states', () => {
        it('renders update available toast', () => {
            ...
            expect(screen.getByTestId('toast-message')).toHaveTextContent('Version 1.2.3 is downloading...');
        });
        ...
        it('renders update downloaded toast', () => {
            ...
            expect(screen.getByTestId('toast-message')).toHaveTextContent('Version 1.2.3 is ready to install.');
        });
        ...
        it('renders default error message when no errorMessage provided', () => {
            ...
            expect(screen.getByTestId('toast-message')).toHaveTextContent('An error occurred while updating.');
        });
    ...
    describe('button actions', () => {
        ...
        it('shows Restart Now and Later buttons for downloaded type', () => {
            ...
            const onLater = vi.fn();
            render(<UpdateToast {...defaultProps} type="downloaded" onInstall={onInstall} onLater={onLater} />);
    ...
    describe('accessibility', () => {
        ...
        it('dismiss button has aria-label', () => {
            ...
            expect(screen.getByTestId('toast-dismiss')).toHaveAttribute('aria-label', 'Dismiss notification');
        });
