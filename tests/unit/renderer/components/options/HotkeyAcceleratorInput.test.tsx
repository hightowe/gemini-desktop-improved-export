...
describe('HotkeyAcceleratorInput', () => {
    ...
    describe('rendering', () => {
        ...
        it('should apply disabled styling when disabled', () => {
            ...
            const container = screen
                .getByRole('button', { name: /keyboard shortcut/i })
                .closest('.hotkey-accelerator-input');
    ...
    describe('keycap display', () => {
        ...
        it('should display Mac-style symbols on macOS', () => {
            setupMockElectronAPI({ platform: 'darwin' });
    ...
    describe('reset functionality', () => {
        ...
        it('should not reset when disabled', () => {
            render(<HotkeyAcceleratorInput {...defaultProps} currentAccelerator="CommandOrControl+Shift+Q" disabled />);
    ...
    describe('accessibility', () => {
        it('should have proper ARIA label for shortcut display', () => {
            ...
            const input = screen.getByRole('button', {
                name: /keyboard shortcut:.*click to change/i,
            });
